...
//                handler.postDelayed(runnable,15000);
                ...
                e.printStackTrace();
                Intent i=new Intent(ACTION_GATT_DEVICE_NOT_FOUND);
                context.sendBroadcast(i);
                connectionFailed();
                // Close the socket
                try {
                    ...
                    i=new Intent(ACTION_GATT_SERVICES_DISCOVERED);
                    context.sendBroadcast(i);
    ...
    private class ConnectedThread extends Thread {
        ...
        public ConnectedThread(BluetoothSocket socket) {
            ...
            try {
                ...
                byte[] _cmd = DeviceCommand.SET_TIME();
                tmpOut.write(_cmd);
            } catch (IOException e) {
                Intent i=new Intent(ACTION_GATT_DISCONNECTED);
                context.sendBroadcast(i);
...
//                    // Read from the InputStream
                    Log.d("bluetooth_test", "run: reading");
                    bytes = mmInStream.read(buffer);
                    call.m_mtbuf.write(buffer,bytes,mmOutStream);
//                    x= x+1;
                } catch (IOException e) {
                    Log.d("bluetooth_test", "catch");
                    Intent i=new Intent(ACTION_GATT_DISCONNECTED);
                    context.sendBroadcast(i);
